      ...
      <div className="container">
        ...
        <div style={styles.heroCard}>
          ...
          <p style={styles.heroSubtitle}>
            {isEdit
              ? "Actualizá los datos del alumno. Solo completá la contraseña si querés cambiarla."
              : "Completá el formulario para registrar un nuevo alumno en el sistema."}
          </p>
        </div>
        ...
        <div style={styles.sectionTitle}>
          ...
          {isEdit ? "Datos del alumno" : "Nuevo alumno"}
        </div>
                  ...
                  <Field label="Contraseña">
                    <div style={styles.inputGroup}>
                      ...
                      <button
                        ...
                        onMouseEnter={(e) => {
                          e.currentTarget.style.background = "#e4eaf0";
